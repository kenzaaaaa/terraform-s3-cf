...
###################################
resource "aws_kms_key" "S3_buckets_stage_key" {
  description = "This key is used to encrypt Stage S3 bucket objects"
...
#   key_id = aws_kms_key.S3_buckets_stage_key".id
...
#       "kms:DescribeKey",
#     ]
#     resources = [ "S3_buckets_stage_key".arn" ]
#   }
# }