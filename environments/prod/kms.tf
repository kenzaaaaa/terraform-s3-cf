...
###################################
resource "aws_kms_key" "S3_buckets_prod_key" {
  description = "This key is used to encrypt Prod S3 bucket objects"
...
#   key_id = aws_kms_key.S3_buckets_prod_key.id
...
#       "kms:DescribeKey",
#     ]
#     resources = [ "S3_buckets_prod_key.arn" ]
#   }
# }