...
module "cloudfront1" {
  ...
  origin_access_control_name = "CloudFront_Distribution1_Dev-origin_access_control"
}
...
module "cloudfront2" {
  ...
  origin_access_control_name = "CloudFront_Distribution2_Dev-origin_access_control"
}
...
module "cloudfront3" {
  ...
  origin_access_control_name = "CloudFront_Distribution3_Dev-origin_access_control"
}